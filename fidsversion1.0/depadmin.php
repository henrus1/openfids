...
if(!$ttable){
	...
	while (list($airlinecode,$flightno,$departs,$departstime,$airport,$registration,$slottime,$edt,$bay,$gate,$aircraft,$checkin,$status,$type,$staffmsg)=mysql_fetch_row($ttable)){
